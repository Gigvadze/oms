    ...
    stages {
        ...
        stage('plan') {
            steps {
                ...
                sh 'docker run -w /app -w /key -v /home/henadiy/Terraform:/key -v `pwd`:/app hashicorp/terraform:light plan -var-file=variables.tfvars'
            }
        }
        stage('approval') {
            options {
        ...
        stage('apply') {
            steps {
                ...
                sh 'docker run -w /app -w /key -v /home/henadiy/Terraform:/key -v `pwd`:/app hashicorp/terraform:light apply -auto-approve -var-file=variables.tfvars'
                cleanWs()
            }
        }
