...
resource "aws_instance" "web" {
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      "docker run -it --rm -p 8080:8080 -v /var/lib/jenkins/workspace/omspipe/target/OMS.war:/usr/local/tomcat/webapps/ROOT.war -v /var/lib/jenkins/workspace/omspipe/target/OMS:/usr/local/tomcat/webapps/ROOT webserver"
